...
namespace OFEC {
	namespace CDG_MOEA {
		...
		EvalTag  CDGMOEA_pop::evolve_mo() {		//step2:reproduction	
			EvalTag tag = EvalTag::Normal;
		...
		/******************************CDGMOEA***********************************/
		CDGMOEA::CDGMOEA(const ParamMap &v):algorithm(v.at("algorithm name")),m_pop(v.at("population size")){ }
