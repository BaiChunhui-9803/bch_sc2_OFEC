...
namespace OFEC {
	namespace CEC2015 {
		F8_hybrid3::F8_hybrid3(const ParamMap &v) :
			F8_hybrid3((v.at("problem name")), (v.at("number of variables")), 1) {
		...
		EvalTag F8_hybrid3::evaluateObjective(Real *x, std::vector<Real> &obj) {
