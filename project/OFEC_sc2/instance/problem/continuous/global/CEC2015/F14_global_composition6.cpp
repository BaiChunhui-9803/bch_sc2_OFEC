...
namespace OFEC {
	namespace CEC2015 {
		F14_global_composition6::F14_global_composition6(const ParamMap &v) :
			F14_global_composition6((v.at("problem name")), (v.at("number of variables")), 1) {
		...
		void F14_global_composition6::setFunction() {
			basic_func f(7);
		...
		EvalTag F14_global_composition6::evaluateObjective(Real *x, std::vector<Real> &obj) {
