...
namespace OFEC {
	namespace CEC2015 {
		F6_hybrid1::F6_hybrid1(const ParamMap &v) :
			F6_hybrid1((v.at("problem name")), (v.at("number of variables")), 1) {
		...
		EvalTag F6_hybrid1::evaluateObjective(Real *x, std::vector<Real> &obj) {
