...
namespace OFEC {
	DTLZ4::DTLZ4(param_map & v) : 
		DTLZ4(v.at("problem name"), (v.at("numObj") + v.at("interTest1") - 1), v.at("numObj")) { // param_interTest1 = 10 is recommended
	}
	...
	EvalTag DTLZ4::evaluateObjective(Real *x, std::vector<Real> &obj) {
		Real g = 0;
