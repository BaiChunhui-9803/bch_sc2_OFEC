...
namespace OFEC {
	GLT6::GLT6(param_map & v) : GLT6(v.at("problem name"), v.at("number of variables")) { //param_numDim = 30 is suggested
	...
	EvalTag GLT6::evaluateObjective(Real *x, std::vector<Real> &obj) {
		Real yj, g = 0;
