...
namespace OFEC {
	namespace CEC2015 {
		F15_composition2015_C7::F15_composition2015_C7(const ParamMap &v) :
		...
		void F15_composition2015_C7::initialize() {   // don't set optima
			...
			if (m_num_vars == 10) m_pre_opt_distance = 139;
			else if (m_num_vars == 20) m_pre_opt_distance = 191;
			else if (m_num_vars == 30) m_pre_opt_distance = 301;
			
			m_initialized = true;
			
		}
		EvalTag F15_composition2015_C7::evaluateObjective(Real *x, std::vector<Real> &obj) {
