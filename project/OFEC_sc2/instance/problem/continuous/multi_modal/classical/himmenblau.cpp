...
namespace OFEC {
	...
	himmenblau::himmenblau(const ParamMap &v) : 
		himmenblau((v.at("problem name")), 2, 1) {
	...
	EvalTag himmenblau::evaluateObjective(Real *x, std::vector<Real> &obj) {
		Real s = 0;
