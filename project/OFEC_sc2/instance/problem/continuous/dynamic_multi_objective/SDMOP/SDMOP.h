//Register SDMOP "SDMOP" DMOP,ConOP
...
namespace OFEC {
	...
	private:
		...
		std::vector<std::vector<std::vector<Real>>> m_x;//store the location of peaks of all subobjectives
		std::vector<std::vector<std::vector<Real>>> m_x0;//store the initial value of m_x
