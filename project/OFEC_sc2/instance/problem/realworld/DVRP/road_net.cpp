...
namespace OFEC {
	namespace DVRP {
		...
		void road_net::read_data(const std::string &road_file_name, const std::string &velocity_file_name_Offline, const std::string &velocity_file_name_Online) {
			...
			std::string road_file = static_cast<std::string>(g_working_dir) + "/instance/problem/realworld/DVRP/data/" + road_file_name + ".txt";
			std::string velocity_file_Offline = static_cast<std::string>(g_working_dir) + "/instance/problem/realworld/DVRP/data/OffLine/" + velocity_file_name_Offline + ".txt";
			std::string velocity_file_Online = static_cast<std::string>(g_working_dir) + "/instance/problem/realworld/DVRP/data/OnLine/" + velocity_file_name_Online + ".txt";
		...
		void road_net::select_customers(const size_t depot, const size_t static_order_num, const size_t dynamic_order_num, const double depart_time, const double dynamic_endtime, int id_rnd) {
			...
			GET_RND(id_rnd).uniform.shuffle(random_sequence.begin(), random_sequence.end());
			...
			GET_RND(id_rnd).uniform.shuffle(random_disclosure_time1.begin(), random_disclosure_time1.end());
			...
			for (size_t i = 0; i < random_sequence.size(); ++i) {
				...
				std::iota(random_disclosure_time2.begin(), random_disclosure_time2.end(), depart_time);
				GET_RND(id_rnd).uniform.shuffle(random_disclosure_time2.begin(), random_disclosure_time2.end());
