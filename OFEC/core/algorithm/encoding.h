...
namespace OFEC {	
	...
	public:	
		...
		SolBase(const SolBase&) = default;
		SolBase(SolBase&&) = default;
		
		virtual ~SolBase() {};
		SolBase& operator=(const SolBase&) = default;
		SolBase& operator=(SolBase&&) = default;
	...
	public:
		...
		VarVec& operator=(const VarVec& rhs) = default;
