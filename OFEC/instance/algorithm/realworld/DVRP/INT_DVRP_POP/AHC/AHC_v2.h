...
namespace OFEC {
	...
	protected:
		...
		const std::vector<std::vector<Real>>& cacul_dis_matrix(const std::vector<size_t> &data, int id_pro);
		Real cacul_d_conflict(size_t i, size_t j, int id_pro);
		Real cacul_tw_conflict(size_t i, size_t j, int id_pro);
