...
namespace OFEC {
	...
	template <typename Population1, typename Population2, typename Individual>
	LRM_ADOPT<Population1, Population2, Individual>::LRM_ADOPT(param_map & v) : algorithm(v.at("algorithm name")), \
	...
	template <typename Population1, typename Population2, typename Individual>
	void LRM_ADOPT<Population1, Population2, Individual>::initialize() {
	...
	template <typename Population1, typename Population2, typename Individual>
	void LRM_ADOPT<Population1, Population2, Individual>::run_() {
		EvalTag tag = EvalTag::Normal;

		while (tag != EvalTag::Terminate) {
	...
	template <typename Population1, typename Population2, typename Individual>
	EvalTag LRM_ADOPT<Population1, Population2, Individual>::evolve() {
	...
	template <typename Population1, typename Population2, typename Individual>
	void LRM_ADOPT<Population1, Population2, Individual>::update_distance(size_t idx) {
		Real min_distance;
	...
	template <typename Population1, typename Population2, typename Individual>
	bool LRM_ADOPT<Population1, Population2, Individual>::update_alternative_solution(size_t idx, Individual & indi) {
		for (auto& i : m_alternative) {
	...
	template <typename Population1, typename Population2, typename Individual>
	void LRM_ADOPT<Population1, Population2, Individual>::record() {
		//measure::get_measure()->record(global::ms_global.get(), 0, 0);
	}

	template <typename Population1, typename Population2, typename Individual>
	Real LRM_ADOPT<Population1, Population2, Individual>::cal_standard_deviation(const std::vector<float>& vec1, const std::vector<float>& vec2) {
	...
	template <typename Population1, typename Population2, typename Individual>
	Real LRM_ADOPT<Population1, Population2, Individual>::cal_coverage_rate() {
	...
	template <typename Population1, typename Population2, typename Individual>
	void LRM_ADOPT<Population1, Population2, Individual>::record_intermediate_result() {
	...
	template <typename Population1, typename Population2, typename Individual>
	void LRM_ADOPT<Population1, Population2, Individual>::output() {
	...
	template <typename Population1, typename Population2, typename Individual>
	void LRM_ADOPT<Population1, Population2, Individual>::generate_training_data() {
	...
	template <typename Population1, typename Population2, typename Individual>
	void LRM_ADOPT<Population1, Population2, Individual>::establish_logistic_regression(Real  rate, int iter) {
	...
	template <typename Population1, typename Population2, typename Individual>
	std::vector<Real> LRM_ADOPT<Population1, Population2, Individual>::D2_transform_D1(const std::vector<std::vector<Real>> data) {
		int size1 = data.size();
	...
	template <typename Population1, typename Population2, typename Individual>
	void LRM_ADOPT<Population1, Population2, Individual>::update_index_flag() {
		int num_node = CAST_RP_EPANET->number_node();
	...
	template <typename Population1, typename Population2, typename Individual>
	template <typename Population>
	bool LRM_ADOPT<Population1, Population2, Individual>::is_feasible_population(const Real tar, const Population & pop) {
	...
	template <typename Population1, typename Population2, typename Individual>
	template <typename Population>
	void LRM_ADOPT<Population1, Population2, Individual>::local_search(Population & pop) {  // 0.2 0.5 0.8
