...
namespace OFEC {
	...
	ESs::ESs(param_map & v) : algorithm(v.at("algorithm name")), m_pop(v.at("population size"), 1, v.at("subpopulation size"), v.at("beta"), v.at("alpha")), m_path_result(v.at("dataFileResult"))
	{
	...
	//	
	//	path << g_working_dir << "/result/new/Alg4Epa/ESs/" << m_path_result;
	...
	//	path2 << g_working_dir << "/result/new/Alg4Epa/ESs/NET2_97/20w/curr_best_obj.txt";
