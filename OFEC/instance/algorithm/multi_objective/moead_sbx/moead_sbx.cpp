...
namespace OFEC {
	...
	EvalTag MOEAD_SBX_pop::evolve_mo() {
		EvalTag tag = EvalTag::Normal;
	...
	MOEAD_SBX::MOEAD_SBX(const ParamMap &v) :algorithm(v.at("algorithm name")), m_pop(v.at("population size")) { }
