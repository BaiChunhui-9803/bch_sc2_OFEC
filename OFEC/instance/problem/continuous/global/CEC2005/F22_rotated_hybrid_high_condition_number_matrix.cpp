...
namespace OFEC {
	namespace CEC2005 {
		void RotatedHybridHighConditionNumberMatrix::initialize_() {
		...
		void RotatedHybridHighConditionNumberMatrix::evaluateObjective(Real *x, std::vector<Real> &obj) {
			Composition::evaluateObjective(x, obj);
			obj[0] += 360.;
		}

		void RotatedHybridHighConditionNumberMatrix::setFunction() {
			basic_func f(5);
			...
			m_function[0]->setConditionNumber(10.); m_function[1]->setConditionNumber(20.);
			m_function[2]->setConditionNumber(50.); m_function[3]->setConditionNumber(100.);
			m_function[4]->setConditionNumber(200.); m_function[5]->setConditionNumber(1000.);
			m_function[6]->setConditionNumber(2000.); m_function[7]->setConditionNumber(3000.);
			m_function[8]->setConditionNumber(3000.); m_function[9]->setConditionNumber(5000.);
