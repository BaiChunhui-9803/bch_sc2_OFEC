...
namespace OFEC {
	namespace CEC2015 {
		F12_global_composition4::F12_global_composition4(const ParamMap &v) :
			F12_global_composition4((v.at("problem name")), (v.at("number of variables")), 1) {
		...
		void F12_global_composition4::setFunction() {
			basic_func f(5);
		...
		EvalTag F12_global_composition4::evaluateObjective(Real *x, std::vector<Real> &obj) {
