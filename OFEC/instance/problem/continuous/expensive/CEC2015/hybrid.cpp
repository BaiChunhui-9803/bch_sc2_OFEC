...
namespace OFEC {
	namespace CEC2015 {
		...
		continuous(name, size_var, size_obj), m_random_perm(size_var), m_temp_sol(m_num_objs, num_constraints(), m_num_vars)

    {
		...
		EvalTag hybrid::evaluateObjective(Real *x, std::vector<Real> &obj) {
			size_t count = 0;
