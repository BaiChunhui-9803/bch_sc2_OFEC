...
namespace OFEC::CEC2013 {
	...
	void Composition4::setFunction() {
		basic_func f(4);
		f[0] = &create_function<Rastrigin>;
		f[1] = &create_function<GriewankRosenbrock>;
	...
	void Composition4::evaluateObjective(Real *x, std::vector<Real> &obj) {
